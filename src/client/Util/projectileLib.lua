...
function ProjectileLib.computeLaunchAngle(horizontalDistance, distanceY, intialSpeed, g) -- gravity must be (+)number
...
function ProjectileLib.ComputeLaunchVelocity(distanceVector, initialSpeed, g, allowOutOfRange) -- gravity: (+)number
	...
	local isInRange, launchAngle = ProjectileLib.computeLaunchAngle(horizontalDistance, distanceVector.Y, initialSpeed, g)
...
function ProjectileLib.ComputeLaunchVelocityBeam(distanceVector, initialSpeed, g, allowOutOfRange) -- gravity: (+)number
	...
	local isInRange, launchAngle = ProjectileLib.computeLaunchAngle(horizontalDistance, distanceY, initialSpeed, g)
	if not isInRange and not allowOutOfRange then return end
